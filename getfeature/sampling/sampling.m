...
close all;
%-----------------------------------------------------------main parameters
K=633151; %total data points
N=100500; %subset of selected data
...
load new_attr.mat
%attr = attr(1:50000, :);
idx1 = new_attr(:,1) < 0.15;
idx2 = new_attr(:,2) < 0.05;
idx3 = new_attr(:,3) < 1.0;
idx4 = new_attr(:,4) > 0.0 & new_attr(:,4) < 0.7;
idx5 = new_attr(:,5) < 0.6;
idx6 = new_attr(:,6) < 0.2;
