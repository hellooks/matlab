...
set(gca,'FontName','Helvetica','FontSize',11,'YTick',0:25:125)

xlabel('Brightness','FontSize', 11, 'Fontname', 'Helvetica');
ylabel('Colorfulness', 'FontSize', 11, 'Fontname', 'Helvetica')
% 
% figure('Position', [400,500,430,270])
...
% set(gca,'FontName','Helvetica','FontSize',11,'YTick',0:25:125)
% 
% xlabel('Contrast','FontSize', 11, 'Fontname', 'Helvetica');
% ylabel('Colorfulness', 'FontSize', 11, 'Fontname', 'Helvetica');
