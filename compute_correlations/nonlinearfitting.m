...
% subjectiveValues=rescale(subjectiveValues,0,5)
...
plot(objectiveValues,subjectiveValues,'+b','LineWidth',1,'color',[105,102,47]/255);
set(gca,'FontSize',13, 'Fontname', 'Times');
set(gca,'xtick',0:1:5,'FontSize',13, 'Fontname', 'Times');
ylabel('Prediction','FontSize', 13, 'Fontname', 'Times')
% xticklabels({'','','','','5','','','','','10','','','','','15','','','','','20'});
xlabel('CD', 'FontSize', 13, 'Fontname', 'Times');
xlim([0,5])
