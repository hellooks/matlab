function [SROCC,KROCC,PLCC,RMSE,ypre,betam,ehat,J] = ...
    nonlinearfitting(objectiveValues, subjectiveValues)
%   input:
...
objectiveValues=rescale(objectiveValues,0.5,9.5)
...
figure('Position', [400,500,400,270])
% figure('Position',  [400,500,415,285])
set(gca,'LineWidth',1.4);  %将图中的曲线加粗，1.0表示线的粗细
% [57,204,204]/255
...
plot(objectiveValues,subjectiveValues,'+b','LineWidth',1,'color',[250,210,63]/255);
set(gca,'ytick',0:2:10,'FontSize',25, 'Fontname', 'Helvetica');
set(gca,'xtick',0:2:10,'FontSize',25, 'Fontname', 'Helvetica');
ylabel('\DeltaE','FontSize', 25, 'Fontname', 'Helvetica')
% xticklabels({'','','','','5','','','','','10','','','','','15','','','','','20'});
xlabel('\DeltaV', 'FontSize', 25, 'Fontname', 'Helvetica');
xlim([0,10])
