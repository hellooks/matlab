function draw_method(x,y)
%   散点图 score and mos x=mos
%   此处显示详细说明
...
% a=polyfit(x,y,2)
% z=polyval(a,x)
scatter(x,y,20,'.','MarkerEdgeColor',[105,102,47]/255,'MarkerFaceColor',[105,102,47]/255)
xlim([0,5])
ylim([0,5])
% hold on
% plot(x,z)
...
xlabel('CD ratings', 'FontSize', 13, 'Fontname', 'Times');
% ylim([0,5])
xlim([0,5])
