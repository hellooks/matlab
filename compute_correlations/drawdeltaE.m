...
% 
set(gca,'ytick',0:1500:7500,'FontSize',11,'Fontname', 'Helvetica','LineWidth',1.3);
set(gca,'xtick',0:1:10,'FontSize',11,'Fontname', 'Helvetica','LineWidth',1.3);
% xticks(0:0.5:4.5)
% xticklabels({'0.0','1','2','3','1.5','2.0','2.5','3.0','3.5','4.0','4.5'})
% set(gca,'xTickLabel','xtick','%.2f');
ylabel("Count", 'FontSize', 11, 'Fontname', 'Helvetica','LineWidth',1.3)
